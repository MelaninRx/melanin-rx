...
export default function FetalDevelopment({ currentWeek }: FetalDevelopmentProps) {
  ...
  return (
    <div className={styles.fetalCard}>
      <div className={styles.fetalTitle}>Fetal Development</div>
      ...
      <div className={styles.fetalContent}>
        <div style={{ position: 'relative', width: '130px', height: '130px' }}>
          ...
          <div className={styles.fetalWeek} style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>{currentWeek}w</div>
        </div>
